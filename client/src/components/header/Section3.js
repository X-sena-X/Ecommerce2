...
export default function Section3() {
    return (
        <div className='section3 grid lg:grid-cols-2 mt-32 grid-cols-1 w-screen h-auto bg-white'>
            <div className='leftSide flex flex-col bg-gray-200 items-center justify-center'>
                <div className='Container1 relative flex h-52 rounded-3xl bg-white mx-5 my-2 items-center justify-center'>
                    <div className='absolute w-full h-full '>
                        <img src={image1} className="h-full w-full object-cover rounded-2xl  "alt="banner1"/>
                    </div>
                    <div className='flex flex-col items-center justify-center'>
                        <span className='text-black font-bold text-2xl z-10 '>GET UPTO 50% OFF</span>
                        <button className='w-32 h-10 bg-gray-100 rounded-xl text-sm mt-4 z-10'>Get Discount</button>
                    </div>

                </div>
                <div className='Container1 relative flex h-52 rounded-3xl bg-white mx-5 my-2 items-center'>
                        <div className='absolute w-full h-full '>
                            <img src={image2} className="h-full w-full object-cover rounded-2xl "alt="banner1"/>
                        </div>
                ...
                <div className='flex relative flex-row lg:space-x-28 space-x-5 mt-3'>
                    <div className='Container4 flex relative h-44 w-44 lg:h-64 lg:w-64 rounded-3xl justify-center items-center'>
                        <div className='absolute w-full h-full '>
                            <img src={image4} className="h-full w-full object-cover rounded-2xl "alt="banner1"/>
                        </div>
                        ...
                        <button className='h-8 lg:w-18 absolute bottom-0 mb-8 opacity-60 bg-transparent rounded-xl border-black border-2 text-sm px-3'>Avail Offers</button>
                    </div>
            ...
            <div className='grid mt-3 lg:mt-0'>
                <div className='rightSide grid lg:grid-cols-2 grid-cols-1 lg:space-x-1 space-y-5 lg:space-y-0 place-items-center'>
                    <div className='Container2 flex bg-gray-100 relative rounded-2xl  '>
                        <div className='absolute w-full h-full '>
                            <img src={image6} className="h-full w-full object-cover rounded-2xl"alt="banner1"/>
                        </div>
                    ...
                    <div className='Container2 bg-gray-100 flex relative rounded-2xl'>
                        <div className='absolute w-full h-full '>
                            <img src={image5} className="h-full w-full object-cover rounded-2xl"alt="banner1"/>
                        </div>
                ...
                <div className='Container3 relative block h-48 bg-red-600 mt-3 ml-7 rounded-2xl self-center'>
                        <div className='absolute w-full h-full '>
                            <img src={image3} className="h-full w-full object-cover rounded-2xl"alt="banner1"/>
                        </div>
                    <div className='absolute right-0 top-0 m-4 h-6 w-8 rounded-3xl items-center justify-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
