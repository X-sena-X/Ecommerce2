const products = [
    { 
        ...
        title: {
            shortTitle: 'pigeon Electric Kettle',
    ...
    { 
        id: 'product2',
        url: 'https://i.imgur.com/aJEnOLn.png', 
        detailUrl: 'https://i.imgur.com/aJEnOLn.png',
        title: {
            shortTitle: 'Iphone 14 ProMax',
            longTitle: ''
        },
        price: {
            mrp: 1499,
    ...
    { 
        id: 'product3',
        url: 'https://i.imgur.com/hGW6RNK.png', 
        detailUrl: 'https://i.imgur.com/hGW6RNK.png', 
        title: {
            shortTitle: 'Macbook Pro',
            longTitle: 'The MacBook Pro is a high-performance laptop designed by Apple, known for its sleek design, powerful hardware, and advanced features geared towards professionals and creative users.'
        }, 
        price: {
            mrp: 499,
            cost: 166,
